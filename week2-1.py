...
def aes_ctr_decrypt(key, cipher):
    ...
    cipher_ascii = cipher[AES.block_size:]
    iv = long(cipher[:AES.block_size].encode('hex'), 16)
...
CIPHER_1 ='4ca00ff4c898d61e1edbf1800618fb2828a226d160dad078' \
          ...
          'fb94ffe0c5da05d9476be028ad7c1d81'.decode('hex')
...
# Q. 3
KEY_3 = '36f18357be4dbd77f050515c73fcf9f2'.decode('hex')
CIPHER_3 = '69dda8455c7dd4254bf353b773304eec0ec7702330098ce7f7520d1cbbb20fc3' \
           ...
           '5f51eeca32eabedd9afa9329'.decode('hex')

# Q. 4
KEY_4 = '36f18357be4dbd77f050515c73fcf9f2'.decode('hex')
CIPHER_4 = '770b80259ec33beb2561358a9f2dc617e46218c0a53cbeca695ae45fa' \
           'a8952aa0e311bde9d4e01726d3184c34451'.decode('hex')
