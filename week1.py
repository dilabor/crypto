...
"""
# Week 1 - Problem set
from utils import hex_encode, xor, hex_decode


def resolve_q7():
    cipher = r'6c73d5240a948c86981bc294814d'
    plaintext = r'attack at dawn'
    key = xor(cipher, hex_encode(plaintext))

    # Encode the new secret message
    plaintext = r'attack at dusk'
    cipher = xor(key, hex_encode(plaintext))
    print cipher
...
CIPHER_TEXTS = [
    ...
    r'3f561ba9adb4b6ebec54424ba317b564418fac0dd35f8c08d31a1fe9e24fe56808c213f17c81d9607cee021dafe1e001b21ade877a5e68bea88d61b93ac5ee0d562e8e9582f5ef375f0a4ae20ed86e935de81230b59b73fb4302cd95d770c65b40aaa065f2a5e33a5a0bb5dcaba43722130f042f8ec85b7c2070',
    r'',
    r'',
    r'315c4eeaa8b5f8bffd11155ea506b56041c6a00c8a08854dd21a4bbde54ce56801d943ba708b8a3574f40c00fff9e00fa1439fd0654327a3bfc860b92f89ee04132ecb9298f5fd2d5e4b45e40ecc3b9d59e9417df7c95bba410e9aa2ca24c5474da2f276baa3ac325918b2daada43d6712150441c2e04f6565517f317da9d3',
    r'',
    r'466d06ece998b7a2fb1d464fed2ced7641ddaa3cc31c9941cf110abbf409ed39598005b3399ccfafb61d0315fca0a314be138a9f32503bedac8067f03adbf3575c3b8edc9ba7f537530541ab0f9f3cd04ff50d66f1d559ba520e89a2cb2a83'
]

SECRET = r'32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904'
...
def sweep():
    ...
    for c in CIPHER_TEXTS:
        scramble = hex_decode(xor(c, SECRET), as_ascii=True)
...
def guess_key():
    ...
    """
    return xor(SECRET, hex_encode(GUESS))
...
def guess_key_fully():
    ...
    """
    return xor(CIPHER_TEXTS[8], hex_encode(MSG_8))
...
def get_messages(key):
    ...
    """
    messages = [hex_decode(xor(key, encrypted), as_ascii=True)
                for encrypted in CIPHER_TEXTS]
    return messages
...
if __name__ == '__main__':
    ...
    for i, secret in enumerate(CIPHER_TEXTS):
        junk = hex_decode(xor(CIPHER_TEXTS[8], secret), as_ascii=True)
        ...
        print i, ''.join(guess)
    print '==='
    key = xor(CIPHER_TEXTS[8], hex_encode(MSG_8))
    decrypted_secret = hex_decode(xor(key, SECRET), as_ascii=True)
